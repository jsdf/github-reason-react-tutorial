...
function make(method_, headers, body, referrer, $staropt$star, mode, credentials, cache, redirect, $staropt$star$1, keepalive) {
  ...
  var partial_arg = map(Js_boolean.to_js_boolean, keepalive);
  var partial_arg$1 = /* Some */[integrity];
  var partial_arg$2 = map(encodeRequestRedirect, redirect);
  var partial_arg$3 = map(encodeRequestCache, cache);
  var partial_arg$4 = map(encodeRequestCredentials, credentials);
  var partial_arg$5 = map(encodeRequestMode, mode);
  var partial_arg$6 = /* Some */[encodeReferrerPolicy(referrerPolicy)];
  var partial_arg$7 = map(encodeRequestMethod, method_);
  return (function () {
      return {
              method: partial_arg$7 ? partial_arg$7[0] : undefined,
              headers: headers ? headers[0] : undefined,
              body: body ? body[0] : undefined,
              referrer: referrer ? referrer[0] : undefined,
              referrerPolicy: partial_arg$6 ? partial_arg$6[0] : undefined,
              mode: partial_arg$5 ? partial_arg$5[0] : undefined,
              credentials: partial_arg$4 ? partial_arg$4[0] : undefined,
              cache: partial_arg$3 ? partial_arg$3[0] : undefined,
              redirect: partial_arg$2 ? partial_arg$2[0] : undefined,
              integrity: partial_arg$1 ? partial_arg$1[0] : undefined,
              keepalive: partial_arg ? partial_arg[0] : undefined
            };
    });
}
