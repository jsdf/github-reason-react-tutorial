...
function Runner(A) {
  var test$1 = function (name, callback) {
    test(name, (function () {
            Curry._1(A[/* assert_ */0], Curry._1(callback, /* () */0));
            return undefined;
          }));
    return /* () */0;
  };
  ...
  var testPromise = function (name, callback) {
    test(name, (function () {
            return Curry._1(callback, /* () */0).then((function (a) {
                          return Promise.resolve(Curry._1(A[/* assert_ */0], a));
                        }));
          }));
    return /* () */0;
  };
  var test$2 = function (name, callback) {
...
function testOnly(name, callback) {
  test.only(name, (function () {
          assert_(Curry._1(callback, /* () */0));
          return undefined;
        }));
...
function testAsyncOnly(name, callback) {
  test.only(name, (function (done_) {
          Curry._1(callback, (function ($$case) {
                  assert_($$case);
                  return Curry._1(done_, /* () */0);
...
function testPromiseOnly(name, callback) {
  test.only(name, (function () {
          return Curry._1(callback, /* () */0).then((function () {
                        return Promise.resolve(assert_);
                      }));
        }));
  return /* () */0;
}
...
function toThrowErrorMatchingSnapshot(param) {
  return mapMod((function (f) {
                return /* ThrowsMatchSnapshot */Block.__(21, [f]);
              }), param);
}

function toThrowMessage(message) {
  return (function (param) {
      return mapMod((function (f) {
                    return /* ThrowsMessage */Block.__(22, [
                              f,
                              message
                            ]);
                  }), param);
...
function toThrowMessageRe(re) {
  return (function (param) {
      return mapMod((function (f) {
                    return /* ThrowsMessageRe */Block.__(23, [
                              f,
                              re
                            ]);
                  }), param);
...
exports.testAsyncOnly   = testAsyncOnly;
exports.testPromiseOnly = testPromiseOnly;
